...
Solve a 2D elasticity problem on the unit square domain
Boundary conditions: Bottom edge fixed, top edge prescribed vertical displacement
@author: cosmin
"""
#%%
...
deg = 5
num_refinements = 5
output_filename = "elast2d_tension_plate"
